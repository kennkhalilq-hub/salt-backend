...
ADMIN_CHAT_ID  = "YOUR_TELEGRAM_CHAT_ID_HERE"          # your Telegram ID from @userinfobot

# ── Your AI API — only edit these 2 lines ──
API_URL   = "YOUR_API_SITE_URL_HERE"    # paste your API site URL here e.g. https://yoursite.com/api/chat
API_MODEL = "YOUR_MODEL_NAME_HERE"    # the model name e.g. gpt-4o
# ================================================================
