...
# ================================================================
SECRET_KEY     = "Salt123"   # any random string
...
async def chat(data: ChatRequest, current_user=Depends(get_current_user)):
    ...
    # ── Call your AI API ──────────────────────────────────────
    try:
        # Build conversation as plain text for the PHP API
        conversation = ""
        for m in messages:
        ...
        async with httpx.AsyncClient(timeout=60) as client:
            ...
            try:
                ...
                # If not JSON, use plain text response directly
